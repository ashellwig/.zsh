...
PATH="/Users/ccistaff/perl5/bin${PATH:+:${PATH}}"; export PATH;
PERL5LIB="/Users/ccistaff/perl5/lib/perl5${PERL5LIB:+:${PERL5LIB}}"; export PERL5LIB;
PERL_LOCAL_LIB_ROOT="/Users/ccistaff/perl5${PERL_LOCAL_LIB_ROOT:+:${PERL_LOCAL_LIB_ROOT}}"; export PERL_LOCAL_LIB_ROOT;
PERL_MB_OPT="--install_base \"/Users/ccistaff/perl5\""; export PERL_MB_OPT;
PERL_MM_OPT="INSTALL_BASE=/Users/ccistaff/perl5"; export PERL_MM_OPT;
...
export LDFLAGS="-L/Users/ccistaff/SDKs/homebrew/opt/openssl@3/lib"
export CPPFLAGS="-I/Users/ccistaff/SDKs/homebrew/opt/openssl@3/include"
# --- Go ---
# GOPATH
